...
const CREATE_USER_DISPLAY_NAME = process.env.CREATE_USER_DISPLAY_NAME;
...
const { data, error } = await supabase.auth.admin.createUser({
	...
	email_confirm: true,
	user_metadata: {
		display_name: CREATE_USER_DISPLAY_NAME || undefined,
	},
});
...
if (CREATE_USER_DISPLAY_NAME) {
	console.log('  Display name:', CREATE_USER_DISPLAY_NAME);
}
