...
-- 3. Teacher-student links are inserted here; duplicates are ignored via ON CONFLICT.
-- 4. Run `supabase db reset` before seeding to ensure a clean database.
